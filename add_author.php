...
<body class="bg-gray-100 text-gray-900">
  <div class="max-w-5xl mx-auto p-6 space-y-6 ">
    ...
    <div class="bg-white rounded-xl shadow p-6">
      <h2 class="text-lg font-medium mb-4">Add Author</h2>
      <form action="/controllers/author_controller.php" method="POST" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div class="flex gap-2 justify-center items-center">
              <input type="text" class="flex-1 border rounded-md px-3 py-2 text-sm bg-gray-50" name="full_name" required>
            </div>
          </div>
          <div>
            <label class="block text-sm mb-1 text-gray-600 font-semibold">Birth Date</label>
            <div class="flex gap-2 justify-center items-center">
              <input type="date" class="flex-1 border rounded-md px-3 py-2 text-sm bg-gray-50" name="birth_date" required>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <textarea name="biography_summary" class="w-full border rounded-md p-3 text-sm bg-gray-50" required></textarea>
        </div>

        <button type="submit" name="button_add_author"
